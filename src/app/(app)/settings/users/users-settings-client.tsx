...
type SystemRole = "SUPER_ADMIN" | "OWNER" | "ADMIN" | "MEMBER" | "VIEWER";
type UserRow = {
  membershipId: string;
  role: SystemRole;
...
const ROLE_META: Record<
  SystemRole,
  { label: string; tone: "teal" | "amber" | "slate" | "emerald" | "rose" }
> = {
...
export function UsersSettingsClient({
  ...
  const canAssignOwner = currentRole === "OWNER" || currentRole === "SUPER_ADMIN";
