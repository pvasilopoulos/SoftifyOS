    ...
    const item = await prisma.$transaction(async (tx) => {
      ...
      const created = await tx.documentSeries.create({
        data: {
          ...
          allowWriteOff: body.allowWriteOff ?? false,
          ...
          autoPostSettlementJournal: body.autoPostSettlementJournal ?? true,
          allowVoidSettlement: body.allowVoidSettlement ?? true,
          allowBankMatch: body.allowBankMatch ?? true,
