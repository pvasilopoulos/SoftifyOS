export const PERMISSION_CATALOG = [
  ...
  { code: "delivery_notes.read", label: "Δελτία αποστολής — ανάγνωση", group: "Πωλήσεις" },
  { code: "delivery_notes.write", label: "Δελτία αποστολής — εγγραφή", group: "Πωλήσεις" },
  ...
  { code: "finance.read", label: "Οικονομικά — ανάγνωση", group: "Οργάνωση" },
  { code: "finance.write", label: "Οικονομικά — εγγραφή", group: "Οργάνωση" },
  { code: "hr.read", label: "HR — ανάγνωση", group: "Οργάνωση" },
  { code: "hr.write", label: "HR — εγγραφή", group: "Οργάνωση" },
