    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ...
          { k: "Οικονομικά", v: "Ημερολόγιο, ισοζύγιο, AR/AP, ΦΠΑ, myDATA, περίοδοι" },
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "AP στο Finance hub δείχνει ανοιχτά PO και υπόλοιπα αγορών",
        ],
      },
    ],
  },
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Υποχρεώσεις (AP) — αγορές FI & PO",
          "ΦΠΑ περιόδου · Τράπεζες · ουρά myDATA",
          "Περίοδοι — άνοιγμα/κλείσιμο μηνών · κλείσιμο χρήσης με άρθρα 80.xx",
      ...
      },
      {
        ...
        items: [
          ...
          "AR ληξιπρόθεσμα & AP προς πληρωμή",
          "Επεξεργασία ουράς myDATA",
      ...
      },
      {
        type: "callout",
        tone: "info",
        text: "Το λογιστικό σχέδιο ρυθμίζεται στο /settings/gl-accounts. Οι σειρές παραστατικών ορίζουν αν η έκδοση δημιουργεί αυτόματα άρθρα.",
      },
    ],
  },
  {
