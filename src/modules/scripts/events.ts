...
export const SCRIPT_EVENTS_BY_MODULE: Record<EntityModule, ScriptEventDef[]> = {
  CUSTOMERS: [...CRUD_EVENTS, ...FORM_EVENTS, ...LIST_EVENTS],
  PRODUCTS: [...CRUD_EVENTS, ...FORM_EVENTS, ...LIST_EVENTS],
  INVOICES: [
    ...CRUD_EVENTS,
    ...FORM_EVENTS,
    ...LIST_EVENTS,
  ...
  ORDERS: [...CRUD_EVENTS, ...FORM_EVENTS, ...LIST_EVENTS],
  QUOTES: [...CRUD_EVENTS, ...FORM_EVENTS, ...LIST_EVENTS],
  GIFT_CARDS: [...CRUD_EVENTS, ...FORM_EVENTS, ...LIST_EVENTS],
};
